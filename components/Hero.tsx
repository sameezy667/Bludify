    ...
    return (
        <div className="relative w-[300px] h-[540px] lg:w-[360px] lg:h-[640px] z-20 cursor-pointer">
            ...
            >
                ...
                <directionalLight position={[-3, 3, -3]} intensity={0.1} color="#ffffff" />
                <spotLight position={[0, 0, 10]} angle={0.4} penumbra={1} intensity={0.15} color="#ffffff" />
                <pointLight position={[0, -5, 5]} intensity={0.2} color="#00E08F" />
                <pointLight position={[2, 0, 3]} intensity={0.08} color="#666666" />
            ...
            <div className="container mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-10 text-center lg:text-left z-20">
                    ...
                    <motion.h1 
                        ...
                        className="text-4xl sm:text-5xl lg:text-7xl font-normal tracking-tight text-slate-900 dark:text-white leading-[1.15] transition-colors max-w-4xl"
                    >
                        Pre-owned tech,{' '}
